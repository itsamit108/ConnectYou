/**
 * Renders the footer of the chat window with input field, emoji picker, attachment button, and typing indicator.
 * @returns {JSX.Element} The JSX element of the chat footer.
 */
